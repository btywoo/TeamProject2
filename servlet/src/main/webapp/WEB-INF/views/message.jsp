...
<meta charset="UTF-8">
<<<<<<< HEAD
<<<<<<< HEAD:servlet/src/main/webapp/WEB-INF/views/main.jsp
<title>메인</title>
...
<div style="background: #FFE6E6; height: 350px;">
	...
	<div class="container" 
		style="min-height: calc(100vh - 240px); padding: 60px 20px; display:flex; flex-direction: column; 
		...
		<a href="" class="">
			<span class="button" 
				  style="background-color: #D0A9F5; border-color: #D0A9F5; vertical-align: middle; align-items: center; font-weight: bolder; color: white;
				  		height: 60px; padding: 14px 40px; display: inline-flex; border: 1px solid transparent; border-radius: 30px">검사 실시</span>
		</a>
	</div>
</div>
...
>>>>>>> origin/kbj:servlet/src/main/webapp/WEB-INF/views/message.jsp
</body>
</html>